...
public class SpecificationResource {
    ...
    public SpecificationResource(HttpClient httpClient, String rentalCarsUrl) {
    ...
    @GET
    public String displayCarsBySpec() throws HTTPStatusException {
        ...
        return listAllCarSpecificationAsString(allCars);
    }

    // Second part of the test where cars are listed displaying there specification based of SIPP codes
    public static String listAllCarSpecificationAsString(ArrayList<Car> allCars) {

        StringBuilder stringBuilder = new StringBuilder();

        for (Car car : allCars) {

            stringBuilder.append(car.getVehicleSpecString());
